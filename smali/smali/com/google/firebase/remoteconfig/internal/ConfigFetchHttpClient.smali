...
.method fetch(Ljava/net/HttpURLConnection;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;Ljava/util/Date;)Lcom/google/firebase/remoteconfig/internal/j$a;
    ...
    # iziVK: Firebase Remote Config сетевой запрос отключён (обход CleanInterceptor через HttpURLConnection)
    new-instance p0, Lcom/google/firebase/remoteconfig/FirebaseRemoteConfigException;

    const-string p1, "iziVK: Remote Config fetch disabled for privacy"
