...
.field private static final c:Lcom/vk/api/sdk/auth/VKAuthManager;
...
.field public static final e:Lcom/vk/api/sdk/VK;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/vk/api/sdk/VK;->e:Lcom/vk/api/sdk/VK;
    ...
    sput-object v0, Lcom/vk/api/sdk/VK;->c:Lcom/vk/api/sdk/auth/VKAuthManager;
    ...
    sput-object v0, Lcom/vk/api/sdk/VK;->d:Ljava/util/ArrayList;
...
.method public static final a(Lcom/vk/api/sdk/internal/ApiCommand;)Ljava/lang/Object;
    ...
    .line 12
    sget-object v0, Lcom/vk/api/sdk/VK;->b:Lcom/vk/api/sdk/VKApiManager;

    if-eqz v0, :cond_0

    invoke-virtual {p0, v0}, Lcom/vk/api/sdk/internal/ApiCommand;->a(Lcom/vk/api/sdk/VKApiManager;)Ljava/lang/Object;
...
.method public static final a(Landroid/content/Context;)V
    ...
    .line 15
    sget-object v0, Lcom/vk/api/sdk/VK;->c:Lcom/vk/api/sdk/auth/VKAuthManager;

    invoke-virtual {v0, p0}, Lcom/vk/api/sdk/auth/VKAuthManager;->c(Landroid/content/Context;)Landroid/content/SharedPreferences;
...
.method public static final a(Landroid/content/Context;ILjava/lang/String;Ljava/lang/String;Z)V
    ...
    .line 5
    new-instance p4, Lcom/vk/api/sdk/auth/VKAccessToken;

    invoke-direct {p4, p1, p2, p3}, Lcom/vk/api/sdk/auth/VKAccessToken;-><init>(ILjava/lang/String;Ljava/lang/String;)V

    sget-object p1, Lcom/vk/api/sdk/VK;->c:Lcom/vk/api/sdk/auth/VKAuthManager;

    invoke-virtual {p1, p0}, Lcom/vk/api/sdk/auth/VKAuthManager;->c(Landroid/content/Context;)Landroid/content/SharedPreferences;

    move-result-object p0

    invoke-virtual {p4, p0}, Lcom/vk/api/sdk/auth/VKAccessToken;->a(Landroid/content/SharedPreferences;)V

    .line 6
    :cond_0
    sget-object p0, Lcom/vk/api/sdk/VK;->b:Lcom/vk/api/sdk/VKApiManager;
...
.method public static final a(Lcom/vk/api/sdk/VKApiConfig;)V
    ...
    .line 1
    sput-object p0, Lcom/vk/api/sdk/VK;->a:Lcom/vk/api/sdk/VKApiConfig;
    ...
    sput-object v0, Lcom/vk/api/sdk/VK;->b:Lcom/vk/api/sdk/VKApiManager;
    ...
    invoke-virtual {v0, p0}, Lcom/vk/api/sdk/auth/VKAuthManager;->b(Landroid/content/Context;)Lcom/vk/api/sdk/auth/VKAccessToken;
...
.method public static final b()Ljava/lang/String;
    ...
    .line 1
    sget-object v0, Lcom/vk/api/sdk/VK;->a:Lcom/vk/api/sdk/VKApiConfig;
...
.method public static final b(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, v1}, Lcom/vk/api/sdk/auth/VKAuthManager;->a(Landroid/content/Context;)I
    ...
    invoke-direct {v4, v1}, Lcom/vk/api/sdk/VKDefaultValidationHandler;-><init>(Landroid/content/Context;)V
    ...
    invoke-static/range {v21 .. v21}, Lcom/vk/api/sdk/VK;->a(Lcom/vk/api/sdk/VKApiConfig;)V

    .line 6
    invoke-static {}, Lcom/vk/api/sdk/VK;->c()Z
    ...
    invoke-direct {v0}, Lcom/vk/api/sdk/VK;->d()V
...
.method public static final c()Z
    ...
    sget-object v1, Lcom/vk/api/sdk/VK;->a:Lcom/vk/api/sdk/VKApiConfig;
    ...
    invoke-virtual {v0, v1}, Lcom/vk/api/sdk/auth/VKAuthManager;->d(Landroid/content/Context;)Z
...
.method public final a()V
    ...
    invoke-virtual {v0, v1}, Lcom/vk/api/sdk/auth/VKAuthManager;->e(Landroid/content/Context;)V

    .line 8
    sget-object v0, Lcom/vk/api/sdk/VK;->d:Ljava/util/ArrayList;
