...
.method final tryFire(I)Ljava8/util/concurrent/CompletableFuture;
    ...
    .line 1424
    iget-object v0, p0, Ljava8/util/concurrent/CompletableFuture$BiRun;->src:Ljava8/util/concurrent/CompletableFuture;
    ...
    iget-object v3, p0, Ljava8/util/concurrent/CompletableFuture$BiRun;->snd:Ljava8/util/concurrent/CompletableFuture;
    ...
    iget-object v5, p0, Ljava8/util/concurrent/CompletableFuture$BiRun;->dep:Ljava8/util/concurrent/CompletableFuture;
    ...
    .line 1429
    :cond_1
    iput-object v1, p0, Ljava8/util/concurrent/CompletableFuture$BiRun;->src:Ljava8/util/concurrent/CompletableFuture;

    iput-object v1, p0, Ljava8/util/concurrent/CompletableFuture$BiRun;->snd:Ljava8/util/concurrent/CompletableFuture;

    iput-object v1, p0, Ljava8/util/concurrent/CompletableFuture$BiRun;->dep:Ljava8/util/concurrent/CompletableFuture;
