...
.method final tryFire(I)Ljava8/util/concurrent/CompletableFuture;
    ...
    .line 621
    iget-object v0, p0, Ljava8/util/concurrent/CompletableFuture$UniApply;->src:Ljava8/util/concurrent/CompletableFuture;
    ...
    iget-object v3, p0, Ljava8/util/concurrent/CompletableFuture$UniApply;->dep:Ljava8/util/concurrent/CompletableFuture;
    ...
    .line 633
    :try_start_0
    invoke-virtual {p0}, Ljava8/util/concurrent/CompletableFuture$UniApply;->claim()Z
    ...
    :cond_4
    :goto_0
    iput-object v1, p0, Ljava8/util/concurrent/CompletableFuture$UniApply;->src:Ljava8/util/concurrent/CompletableFuture;

    iput-object v1, p0, Ljava8/util/concurrent/CompletableFuture$UniApply;->dep:Ljava8/util/concurrent/CompletableFuture;
