.class final Ljava8/util/concurrent/CompletableFuture$BiAccept;
...
# direct methods
.method constructor <init>(Ljava/util/concurrent/Executor;Ljava8/util/concurrent/CompletableFuture;Ljava8/util/concurrent/CompletableFuture;Ljava8/util/concurrent/CompletableFuture;Ljava8/util/function/BiConsumer;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method final tryFire(I)Ljava8/util/concurrent/CompletableFuture;
    ...
    .line 1347
    iget-object v0, p0, Ljava8/util/concurrent/CompletableFuture$BiAccept;->src:Ljava8/util/concurrent/CompletableFuture;
    ...
    iget-object v3, p0, Ljava8/util/concurrent/CompletableFuture$BiAccept;->snd:Ljava8/util/concurrent/CompletableFuture;
    ...
    iget-object v5, p0, Ljava8/util/concurrent/CompletableFuture$BiAccept;->dep:Ljava8/util/concurrent/CompletableFuture;
    ...
    .line 1352
    :cond_1
    iput-object v1, p0, Ljava8/util/concurrent/CompletableFuture$BiAccept;->src:Ljava8/util/concurrent/CompletableFuture;

    iput-object v1, p0, Ljava8/util/concurrent/CompletableFuture$BiAccept;->snd:Ljava8/util/concurrent/CompletableFuture;

    iput-object v1, p0, Ljava8/util/concurrent/CompletableFuture$BiAccept;->dep:Ljava8/util/concurrent/CompletableFuture;
