...
.method final tryFire(I)Ljava8/util/concurrent/CompletableFuture;
    ...
    .line 767
    iget-object v0, p0, Ljava8/util/concurrent/CompletableFuture$UniRun;->src:Ljava8/util/concurrent/CompletableFuture;
    ...
    iget-object v3, p0, Ljava8/util/concurrent/CompletableFuture$UniRun;->dep:Ljava8/util/concurrent/CompletableFuture;
    ...
    .line 775
    :try_start_0
    invoke-virtual {p0}, Ljava8/util/concurrent/CompletableFuture$UniRun;->claim()Z
    ...
    :cond_3
    :goto_0
    iput-object v1, p0, Ljava8/util/concurrent/CompletableFuture$UniRun;->src:Ljava8/util/concurrent/CompletableFuture;

    iput-object v1, p0, Ljava8/util/concurrent/CompletableFuture$UniRun;->dep:Ljava8/util/concurrent/CompletableFuture;
