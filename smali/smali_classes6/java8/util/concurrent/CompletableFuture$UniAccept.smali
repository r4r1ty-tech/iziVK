.class final Ljava8/util/concurrent/CompletableFuture$UniAccept;
...
# direct methods
.method constructor <init>(Ljava/util/concurrent/Executor;Ljava8/util/concurrent/CompletableFuture;Ljava8/util/concurrent/CompletableFuture;Ljava8/util/function/Consumer;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method final tryFire(I)Ljava8/util/concurrent/CompletableFuture;
    ...
    .line 693
    iget-object v0, p0, Ljava8/util/concurrent/CompletableFuture$UniAccept;->src:Ljava8/util/concurrent/CompletableFuture;
    ...
    iget-object v3, p0, Ljava8/util/concurrent/CompletableFuture$UniAccept;->dep:Ljava8/util/concurrent/CompletableFuture;
    ...
    .line 705
    :try_start_0
    invoke-virtual {p0}, Ljava8/util/concurrent/CompletableFuture$UniAccept;->claim()Z
    ...
    :cond_4
    :goto_0
    iput-object v1, p0, Ljava8/util/concurrent/CompletableFuture$UniAccept;->src:Ljava8/util/concurrent/CompletableFuture;

    iput-object v1, p0, Ljava8/util/concurrent/CompletableFuture$UniAccept;->dep:Ljava8/util/concurrent/CompletableFuture;
