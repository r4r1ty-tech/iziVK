...
.method final tryFire(I)Ljava8/util/concurrent/CompletableFuture;
    ...
    .line 1670
    iget-object v0, p0, Ljava8/util/concurrent/CompletableFuture$OrRun;->dep:Ljava8/util/concurrent/CompletableFuture;
    ...
    iget-object v3, p0, Ljava8/util/concurrent/CompletableFuture$OrRun;->src:Ljava8/util/concurrent/CompletableFuture;

    if-eqz v3, :cond_4

    iget-object v4, p0, Ljava8/util/concurrent/CompletableFuture$OrRun;->snd:Ljava8/util/concurrent/CompletableFuture;
    ...
    .line 1676
    :try_start_0
    invoke-virtual {p0}, Ljava8/util/concurrent/CompletableFuture$OrRun;->claim()Z
    ...
    :cond_3
    :goto_0
    iput-object v1, p0, Ljava8/util/concurrent/CompletableFuture$OrRun;->src:Ljava8/util/concurrent/CompletableFuture;

    iput-object v1, p0, Ljava8/util/concurrent/CompletableFuture$OrRun;->snd:Ljava8/util/concurrent/CompletableFuture;

    iput-object v1, p0, Ljava8/util/concurrent/CompletableFuture$OrRun;->dep:Ljava8/util/concurrent/CompletableFuture;
