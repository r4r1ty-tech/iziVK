...
.method final tryFire(I)Ljava8/util/concurrent/CompletableFuture;
    ...
    .line 1616
    iget-object v0, p0, Ljava8/util/concurrent/CompletableFuture$OrAccept;->src:Ljava8/util/concurrent/CompletableFuture;

    const/4 v1, 0x0

    if-eqz v0, :cond_6

    iget-object v2, p0, Ljava8/util/concurrent/CompletableFuture$OrAccept;->snd:Ljava8/util/concurrent/CompletableFuture;
    ...
    :cond_0
    iget-object v4, p0, Ljava8/util/concurrent/CompletableFuture$OrAccept;->dep:Ljava8/util/concurrent/CompletableFuture;
    ...
    .line 1622
    :try_start_0
    invoke-virtual {p0}, Ljava8/util/concurrent/CompletableFuture$OrAccept;->claim()Z
    ...
    :cond_5
    :goto_0
    iput-object v1, p0, Ljava8/util/concurrent/CompletableFuture$OrAccept;->src:Ljava8/util/concurrent/CompletableFuture;

    iput-object v1, p0, Ljava8/util/concurrent/CompletableFuture$OrAccept;->snd:Ljava8/util/concurrent/CompletableFuture;

    iput-object v1, p0, Ljava8/util/concurrent/CompletableFuture$OrAccept;->dep:Ljava8/util/concurrent/CompletableFuture;
