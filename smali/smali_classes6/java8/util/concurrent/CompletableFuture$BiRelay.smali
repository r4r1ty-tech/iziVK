...
.method final tryFire(I)Ljava8/util/concurrent/CompletableFuture;
    ...
    .line 1486
    iget-object v0, p0, Ljava8/util/concurrent/CompletableFuture$BiRelay;->src:Ljava8/util/concurrent/CompletableFuture;
    ...
    iget-object v3, p0, Ljava8/util/concurrent/CompletableFuture$BiRelay;->snd:Ljava8/util/concurrent/CompletableFuture;
    ...
    iget-object v5, p0, Ljava8/util/concurrent/CompletableFuture$BiRelay;->dep:Ljava8/util/concurrent/CompletableFuture;
    ...
    check-cast v7, Ljava8/util/concurrent/CompletableFuture$AltResult;
    ...
    :cond_4
    :goto_0
    iput-object v1, p0, Ljava8/util/concurrent/CompletableFuture$BiRelay;->src:Ljava8/util/concurrent/CompletableFuture;

    iput-object v1, p0, Ljava8/util/concurrent/CompletableFuture$BiRelay;->snd:Ljava8/util/concurrent/CompletableFuture;

    iput-object v1, p0, Ljava8/util/concurrent/CompletableFuture$BiRelay;->dep:Ljava8/util/concurrent/CompletableFuture;
